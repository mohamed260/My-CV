            ...
            <div class=" px-6 py-3 mx-full md:flex md:justify-between md:items-center">
                ...
                <div class=" items-center md:flex" :class="{'hidden': !isOpen, 'block': isOpen }">
                    <div class="flex flex-col md:flex-row md:mx-6">
                        ...
                        <a class="my-1 text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-500 dark:hover:text-indigo-400 md:mx-4 md:my-0" href="#work">Work</a>
                        <a class="my-1 text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-500 dark:hover:text-indigo-400 md:mx-4 md:my-0" href="#contact">Contact</a>
                    </div>
                </div>
