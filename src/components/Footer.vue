<template>
    <div class="bg-gray-800 text-gray-400 p-6">
        <h1 class="text-xl text-center">Mohamed Fox</h1>
        <div class="flex justify-center my-6">
            <div>
                Contact me: 
            </div>
            <div class="mx-2">
               <a href="https://web.facebook.com/mohamed.alboss.969/">
            ...
            <div class="mx-2">
                <a href="https://twitter.com/Mohamed_Fox2600">
            ...
            <div class="mx-2">
                <a href="https://www.instagram.com/wwwalboss10/">
