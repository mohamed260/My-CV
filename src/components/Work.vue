<template>
    <div id="work" class="mx-5">
        ...
        <div class="text-center my-3">
            <a href="https://github.com/mohamed260" class="mx-2 text-gray-800 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-300" aria-label="Github">
                <svg class="inline w-32 h-32 fill-current" viewBox="0 0 24 24" fill="none"
